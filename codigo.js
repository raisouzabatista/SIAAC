...
function CalcularPonto() {
  ...
  var x = document.getElementById("area2").innerText = "A área dos pontos deu:  " + resultado + " U.a.";

} else {
  var x = document.getElementById("area2").innerText = "Algum valor não foi recebido." ;
