...
function Area1(){
    ...
    var yb = (document.getElementById('Yn').value = "53");
    //i
    var xi = (document.getElementById('Xp').value = "193");
    var yi = (document.getElementById('Yp').value = "187");
}
function Area2(){
    //h
    var xa = (document.getElementById('Xm').value = "220");
    var ya = (document.getElementById('Ym').value = "170");
    //b
    var xb = (document.getElementById('Xn').value = "52");
    var yb = (document.getElementById('Yn').value = "53");
    //i
...
function Area3(){
    ...
    var yb = (document.getElementById('Yn').value = "53");
    //c
    var xi = (document.getElementById('Xp').value = "62");
    var yi = (document.getElementById('Yp').value = "40");
}
function Area4(){
    //a
    var xa = (document.getElementById('Xm').value = "220");
    var ya = (document.getElementById('Ym').value = "170");
    //b
    var xb = (document.getElementById('Xn').value = "62");
    var yb = (document.getElementById('Yn').value = "40");
    //i
    var xi = (document.getElementById('Xp').value = "110");
    var yi = (document.getElementById('Yp').value = "17");
}
function Area5(){
    //a
    var xa = (document.getElementById('Xm').value = "220");
    var ya = (document.getElementById('Ym').value = "170");
    //b
    var xb = (document.getElementById('Xn').value = "155");
    var yb = (document.getElementById('Yn').value = "23");
    //i
    var xi = (document.getElementById('Xp').value = "110");
    var yi = (document.getElementById('Yp').value = "17");
}
function Area6(){
    ...
    var yb = (document.getElementById('Yn').value = "23");
    //i
    var xi = (document.getElementById('Xp').value = "223");
    var yi = (document.getElementById('Yp').value = "53");
}function Area7(){
    //a
    var xa = (document.getElementById('Xm').value = "220");
    var ya = (document.getElementById('Ym').value = "170");
    //b
    var xb = (document.getElementById('Xn').value = "223");
    var yb = (document.getElementById('Yn').value = "53");
    //i
    var xi = (document.getElementById('Xp').value = "227");
    var yi = (document.getElementById('Yp').value = "58");
}